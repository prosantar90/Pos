										...
										<div class="form-wrap">
											<form action="database_backup.php" method="post" id="">
												<div class="form-group">
													...
													<input type="hidden" class="form-control" placeholder="Enter Server Name EX: Localhost" name="server" id="server" value="localhost" required="" autocomplete="on">
												</div>
												<div class="form-group">
													<!-- <label class="control-label mb-10" >Database Username</label> -->
													<input type="hidden" class="form-control" placeholder="Enter Database Username EX: root" name="username" id="username" value="root" required="" autocomplete="on">
												</div>
												<div class="form-group">
													<label class="pull-left control-label mb-10" >Backup Password</label>
												...
												<div class="form-group">
													...
													<input type="hidden" class="form-control" placeholder="Enter Database Name" name="dbname" id="dbname" required="" value="pos" autocomplete="on">
												</div>
												<div class="form-group text-center">
													<button type="submit" name="backupnow" class="btn btn-info btn-rounded">Backup Now</button>
												</div>
											</form>
										</div>
									</div>	
