                                ...
                                <div class="row">   
                                    <div class="col-md-6">
                                        <div class="from-group">
                                            ...
                                            <input class="form-control" type="text" name="ufname" id="ufname" placeholder="Full Name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="from-group">
                                     ...
                                     <div class="col-md-6">
                                        <div class="from-group">
                                            ...
                                            <input class="form-control" type="email" name="uemail" id="uemail" placeholder="Email" required>
                                        </div>
                                    </div>
                                      ...
                                      <div class="col-md-6">
                                        <div class="from-group">
                                            ...
                                            <select class="form-control" name="utype" id="utype" required>
                                                <option value="" selected="true" disabled="disabled">Please select user role</option>
