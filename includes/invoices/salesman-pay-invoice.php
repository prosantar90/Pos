...
if (isset($_GET['salesman_pay_invoice'])) {
    $invoice_no = $_GET['salesman_pay_invoice'];

    $transaction = $transaction->getTransactionById($invoice_no);
    
    if ($transaction) {
        $salesMan = $salesman->getSalesManById($transaction['entity_id']);
            ...
            <table class="table p-0 m-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($salesMan['salesman_name']); ?></td>
                    </tr>
                    <tr>
                        <th>Payment Date</th>
                        <td><?php echo $date; ?></td>
