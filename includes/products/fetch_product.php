...
include '../../session.php';
$json_data= array();
$sql = "SELECT products.product_id, products.product_name, products.product_code, brand.brand_name, 
           units.unit_name, categories.category_name, products.mrp_price, products.quantity, products.p_image 
           FROM products 
...
if(isset($_POST['search']['value'])){
    ...
    $sql .= 
    'WHERE products.product_id LIKE "%'. $search_value.'%"  OR
            products.product_code LIKE "%'. $search_value.'%"
    ';
}
